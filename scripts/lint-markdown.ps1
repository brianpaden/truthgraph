# Lint all markdown files excluding directories from .gitignore
...
foreach ($file in $files) {
    ...
    $output = & uv run pymarkdownlnt -d md013,md022,md031,md032,md036 scan $file.FullName 2>&1 | Out-String
