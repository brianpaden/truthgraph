...
class EmbedResponse(BaseResponseModel):
    ...
    embeddings: Annotated[
        list[list[float]],
        Field(description="List of 384-dimensional embeddings")
    ]
    count: Annotated[
        int,
        Field(description="Number of embeddings generated")
    ]
    dimension: Annotated[
        int,
        Field(description="Dimensionality of embeddings (384)")
    ]
    processing_time_ms: Annotated[
        Optional[float],
        Field(description="Processing time in milliseconds")
    ] = None
...
class SearchResultItem(BaseResponseModel):
    ...
    content: Annotated[
        str,
        Field(description="Evidence content text")
    ]
    source_url: Annotated[
        Optional[str],
        Field(description="Source URL of the evidence")
    ] = None
    ...
    rank: Annotated[
        int,
        Field(ge=1, description="Result rank (1-based)")
    ]
...
class SearchResponse(BaseResponseModel):
    ...
    results: Annotated[
        ...
        Field(description="List of search results ordered by relevance")
    ]
    count: Annotated[
        int,
        Field(description="Number of results returned")
    ]
    query: Annotated[
        str,
        Field(description="Original search query")
    ]
    mode: Annotated[
        str,
        Field(description="Search mode used")
    ]
    query_time_ms: Annotated[
        Optional[float],
        Field(description="Query execution time in milliseconds")
    ] = None
...
class NLIRequest(BaseModel):
    ...
    premise: Annotated[
        ...
        Field(
            min_length=1,
            max_length=2000,
            description="Premise text (evidence)"
        )
    ]
    hypothesis: Annotated[
        ...
        Field(
            min_length=1,
            max_length=2000,
            description="Hypothesis text (claim)"
        )
    ]
...
class NLIBatchRequest(BaseModel):
    ...
    pairs: Annotated[
        ...
        Field(
            min_length=1,
            max_length=50,
            description="List of (premise, hypothesis) pairs (max 50)"
        )
    ]
    batch_size: Annotated[
        int,
        Field(
            ...
            ge=1,
            le=32,
            description="Batch size for processing (1-32)"
        )
    ] = 8
...
class NLIScores(BaseModel):
    ...
    entailment: Annotated[
        float,
        Field(ge=0.0, le=1.0, description="Entailment probability")
    ]
    contradiction: Annotated[
        float,
        Field(ge=0.0, le=1.0, description="Contradiction probability")
    ]
    neutral: Annotated[
        float,
        Field(ge=0.0, le=1.0, description="Neutral probability")
    ]
...
class NLIResponse(BaseResponseModel):
    ...
    label: Annotated[
        ...
        Field(description="Predicted NLI label")
    ]
    confidence: Annotated[
        ...
        Field(
            ge=0.0,
            le=1.0,
            description="Confidence score for predicted label"
        )
    ]
    scores: Annotated[
        NLIScores,
        Field(description="Probability scores for all labels")
    ]
    processing_time_ms: Annotated[
        Optional[float],
        Field(description="Processing time in milliseconds")
...
class NLIBatchResponse(BaseResponseModel):
    ...
    results: Annotated[
        list[NLIResponse],
        Field(description="List of NLI results")
    ]
    count: Annotated[
        int,
    ...
    total_processing_time_ms: Annotated[
        Optional[float],
        Field(description="Total processing time in milliseconds")
    ] = None
...
class VerifyRequest(BaseModel):
    ...
    max_evidence: Annotated[
        ...
        Field(
            ...
            ge=1,
            le=50,
            description="Maximum evidence items to retrieve (1-50)"
        )
    ] = 10
    confidence_threshold: Annotated[
        ...
        Field(
            ...
            ge=0.0,
            le=1.0,
            description="Minimum confidence threshold for verdict"
        )
    ] = 0.7
    search_mode: Annotated[
        Literal["hybrid", "vector", "keyword"],
        Field(description="Evidence search mode")
    ] = "hybrid"
...
class EvidenceItem(BaseResponseModel):
    ...
    content: Annotated[
        str,
        Field(description="Evidence content")
    ]
    source_url: Annotated[
        Optional[str],
        Field(description="Source URL")
    ] = None
    nli_label: Annotated[
        Literal["entailment", "contradiction", "neutral"],
    ...
    nli_confidence: Annotated[
        float,
        Field(ge=0.0, le=1.0, description="NLI confidence score")
    ]
    similarity: Annotated[
        float,
        Field(ge=0.0, le=1.0, description="Semantic similarity to claim")
    ]
...
class VerifyResponse(BaseResponseModel):
    ...
    evidence: Annotated[
        list[EvidenceItem],
        Field(description="Evidence items analyzed")
    ]
    explanation: Annotated[
        str,
        Field(description="Human-readable explanation of verdict")
    ]
    claim_id: Annotated[
        Optional[UUID],
        Field(description="Created claim ID (if persisted)")
    ] = None
    verification_id: Annotated[
        Optional[UUID],
        Field(description="Verification result ID (if persisted)")
    ] = None
    processing_time_ms: Annotated[
        Optional[float],
        Field(description="Total processing time in milliseconds")
...
class VerdictRequest(BaseModel):
    ...
    claim_id: Annotated[
        UUID,
        Field(description="Claim UUID to retrieve verdict for")
    ]
...
class VerdictResponse(BaseResponseModel):
    ...
    claim_text: Annotated[
        str,
        Field(description="Original claim text")
    ]
    verdict: Annotated[
        Literal["SUPPORTED", "REFUTED", "INSUFFICIENT"],
        Field(description="Verdict for the claim")
    ]
    confidence: Annotated[
        float,
        Field(ge=0.0, le=1.0, description="Verdict confidence")
    ]
    reasoning: Annotated[
        Optional[str],
        Field(description="Reasoning for the verdict")
    ] = None
    evidence_count: Annotated[
        int,
        Field(description="Number of evidence items analyzed")
    ]
    supporting_evidence_count: Annotated[
        int,
        Field(description="Count of supporting evidence")
    ]
    refuting_evidence_count: Annotated[
        int,
        Field(description="Count of refuting evidence")
    ]
    created_at: Annotated[
        datetime,
        Field(description="Verdict creation timestamp")
    ]
...
class ErrorDetail(BaseModel):
    ...
    field: Annotated[
        Optional[str],
        Field(description="Field that caused the error (if applicable)")
    ] = None
    message: Annotated[
        str,
    ...
    error_code: Annotated[
        Optional[str],
        Field(description="Application-specific error code")
    ] = None
...
class ErrorResponse(BaseModel):
    ...
    details: Annotated[
        ...
        Field(description="Detailed error information")
    ] = None
    request_id: Annotated[
        Optional[str],
        Field(description="Request tracking ID")
    ] = None
...
class ServiceStatus(BaseModel):
    ...
    status: Annotated[
        ...
        Field(description="Service health status")
    ]
    message: Annotated[
        Optional[str],
    ...
    latency_ms: Annotated[
        Optional[float],
        Field(description="Service latency in milliseconds")
    ] = None
...
class HealthResponse(BaseResponseModel):
    ...
    status: Annotated[
        Literal["healthy", "degraded", "unhealthy"],
        Field(description="Overall system health")
    ]
    timestamp: Annotated[
        datetime,
    ...
    services: Annotated[
        ...
        Field(description="Individual service statuses")
    ]
    version: Annotated[
        str,
